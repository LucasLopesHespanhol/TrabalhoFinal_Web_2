...
export default function deleteuser() {
  ...
  const optionsStatus = [
    ...
    {value: 'false', text: 'Inativo'},
      ...
      const handleDeleteUser = async () => {//func para deletar user
        try {
        ...
        <div className="container">
            <div className="row border-bottom">
                ...
                <div className="form-group p-2">
                    <button className="btn btn-danger" type="button" onClick={handleDeleteUser} >Deletar</button>
                    <Link className="btn btn-secondary ms-2" href="/admin/users">Voltar</Link>
                </div>
                </form>
            </div>
        </div>
